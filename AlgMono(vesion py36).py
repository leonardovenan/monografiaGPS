...
#1
#####################################################################
X1 = float(input('Digite a posicao X do primeiro satelite: '))
Y1 = float(input('Digite a posicao Y do primeiro satelite: '))
Z1 = float(input('Digite a posicao Z do primeiro satelite: '))
#2
#####################################################################
X2 = float(input('Digite a posicao X do segundo satelite: '))
Y2 = float(input('Digite a posicao Y do segundo satelite: '))
Z2 = float(input('Digite a posicao Z do segundo satelite: '))
#3
#####################################################################
X3 = float(input('Digite a posicao X do terceiro satelite: '))
Y3 = float(input('Digite a posicao Y do terceiro satelite: '))
Z3 = float(input('Digite a posicao Z do terceiro satelite: '))
#4
#####################################################################
X4 = float(input('Digite a posicao X do quarto satelite: '))
Y4 = float(input('Digite a posicao Y do quarto satelite: '))
Z4 = float(input('Digite a posicao Z do quarto satelite: '))
#####################################################################
